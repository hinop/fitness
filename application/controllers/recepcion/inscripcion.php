...
class Inscripcion extends CI_Controller {
	...
	public function index()
	{
		...
		//$this->load->view('modulos/administrador/servicio/inscripcion_list',$data);
        //$this->load->view('estructura/footer');
        $this->load->view('estructura/recep/cabecera');
		$this->load->view('modulos/recepcion/inscripcion/inscripcion_list',$data);
    ...
    public function agregarbd()
	{
        ...
        redirect('recepcion/inscripcion/index','refresh');
	}
    ...
    public function modificar()
	{
        ...
        $this->load->view('estructura/recep/cabecera');
		$this->load->view('modulos/recepcion/servicio/inscripcion_modif',$data);
        $this->load->view('estructura/recep/footer');
    ...
    public function nuevaInscripcion()
{
    ...
    public function comprobante(){
        ...
        $html = $this->load->view('modulos/recepcion/reportes/comprobante',$data, true);
