...
class Horario extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('modulos/recepcion/horario/horario_list',$data);
        $this->load->view('estructura/recep/footer');
	}
    public function agregar()
	{
        $this->load->view('estructura/recep/cabecera');
		$this->load->view('modulos/recepcion/horario/horario_form');
        $this->load->view('estructura/recep/footer');
	}
    public function agregarbd()
	{
        ...
        redirect('recepcion/horario/index','refresh');
	}
    ...
    // Convertir la cadena 'Lun - Mar - Jue' en un array
        ...
        $this->load->view('estructura/recep/cabecera');
        $this->load->view('modulos/recepcion/horario/horario_modif',$data);
        $this->load->view('estructura/recep/footer');
	}
