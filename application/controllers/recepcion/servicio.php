...
class Servicio extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->load->view('modulos/recepcion/servicio/serv_list',$data);
    ...
    public function asignar()
        ...
        $this->load->view('estructura/recep/cabecera');
        $this->load->view('modulos/recepcion/servicio/serv_horarioList',$data);
	...
	{ 
        ...
        $this->load->view('modulos/recepcion/servicio/serv_asignar',$data);
        $this->load->view('estructura/recep/footer');
	}
	...
	{    
        ...
        redirect('recepcion/servicio/asignar/' . urlencode($encodedData), 'refresh');
	...
	{   
        $this->load->view('estructura/recep/cabecera');
        $this->load->view('modulos/recepcion/servicio/serv_form');
		$this->load->view('estructura/recep/footer');
    ...
    public function agregarbd()
	{
        ...
        redirect('recepcion/servicio/index','refresh');
	}
    ...
    public function modificar()
	{
        ...
        $this->load->view('modulos/recepcion/servicio/serv_modif',$data);
        $this->load->view('estructura/recep/footer');
	}
