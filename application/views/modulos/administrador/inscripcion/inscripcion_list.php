                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                   ...
                                   <br>
                                    <div class="clearfix"></div>
                                    <a href="<?php echo base_url(); ?>index.php/inscripcion/agregar" class="text-left">
...
?>  
                          ...
                          <td>
                           <!-- Eliminar------> 
                            <?php
                            echo form_open_multipart('inscripcion/eliminarbd');
                            ?>
...
<script>
    ...
    $(document).ready(function() {
        $('#ci').on('input', function() {
            var ci = $(this).val();
            if (ci.length >= 1) {
                $.post('<?php echo base_url('index.php/cliente/buscar'); ?>', {
                        ci: ci
                    },
                    function(data) {
                        var result = '';
