<div class="page-title">
              <div class="title_left">
                <h3>Lista de Clientes <small></small></h3>
              </div>
<br>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <div class="row">
                          <div class="col-sm-12">
                          <a href="<?php echo base_url(); ?>index.php/instructor/agregar" class="text-left">
                                <button type="button" class="btn btn-primary">
                                <i class="fa fa-plus"> Nuevo Instructor</i>
                                </button>
                            </a>
...
?>
                        ...
                        <td>
                          <?php
                            echo form_open_multipart('instructor/modificar');
                            ?>
                          ...
                          <td>
                           <!-- Eliminar------> 
                            <?php
                            echo form_open_multipart('instructor/eliminarbd');
                            ?>
                            <input type="hidden" name="id" value="<?php echo $row->id; ?>">
