...
<body>
	...
	<div id="page_pdf">
		<table id="factura_head">
			<tr>
				...
				<td class="info_empresa">
					<div>
						<span class="h2">REPORTE GENERAL DE INGRESOS </span>
						<p>FTNESS FACTORY </p>
					</div>
				</td>
		...
		<table id="factura_detalle">
			<thead>
				<tr>
					<th class="textcenter" width="100px">N° de Venta</th>
					<th class="textcenter" width="100px">Cliente</th>
					<th class="textcenter" width="50px">Fecha</th>
					<th class="textcenter" width="50px"> Total Bs.</th>
				</tr>
			</thead>
			<tbody id="detalle_productos">
				<?php foreach ($data1 as $item) : ?>
					<tr>
						<td class="textcenter"><?php echo $item['id']; ?></td>
						<td class="textcenter"><?php echo $item['nombre']; ?></td>
						<td class="textcenter"><?php echo $item['fechaInscripcion']; ?></td>
						<td class="textcenter"><?php echo $item['Total']; ?> Bs.</td>
						
						
					</tr>
					<?php $total2 = round($total2 + $item['Total'], 2); ?>
				<?php endforeach; ?>
			...
			<tfoot id="detalle_totales">
				<tr>
					...
					<td colspan="3" class="textright"><span><h3>TOTAL :</h3></span></td>
