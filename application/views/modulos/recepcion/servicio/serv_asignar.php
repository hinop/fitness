...
?>
                    ...
                    <div class="row">
                        ...
                        <h2>Registro de Horario del servicio para <?php echo $row->nombre; ?> <small></small></h2>
                                ...
                                <div class="x_content">
                                    <form class="" action="<?php echo base_url();?>index.php/recepcion/servicio/asignarbd" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" id="cupos" name="cupos" min="1" step="1">
                                                </div>
...
<script>
   $(document).ready(function () {
    ...
    $('#search').on('input', function () {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/recepcion/instructor/search_results'); ?>",
            method: "POST",
            data: { query: query },
...
$(document).ready(function() {
    ...
    $('#diasSemana').change(function() {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/recepcion/horario/cargarHorarios'); ?>",
            type: 'POST',
            data: { idDia: idDia },
            dataType: 'json',
            success: function(data) {
