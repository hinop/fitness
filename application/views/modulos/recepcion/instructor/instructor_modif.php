...
?>
                                    <form class="" action="<?php echo base_url();?>index.php/recepcion/instructor/modificarbd" method="post" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="field item form-group">
                                                    ...
                                                    <input class="form-control" autocomplete="off" value="<?php echo $row->ci;?>" class='optional' name="ci" type="text" required="required" onblur="validarCarnet()" style="text-transform: uppercase;" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="field item form-group">
                                                    ...
                                                    <input class="form-control" value="<?php echo $row->telefono;?>"  autocomplete="off" type="numeric" name="telefono" required='required' data-validate-length-range="8,20" onblur="validarTelefono()" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="field item form-group">
                                                    ...
                                                    <input class="form-control" value="<?php echo $row->direccion;?>" autocomplete="off" type="text" name="direccion" required='required' onblur="validarDomicilio()"data-validate-length-range="8,20" style="text-transform: uppercase;" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="field item form-group">
                                                    ...
                                                    <input class="form-control" value="<?php echo $row->especialidad;?>" autocomplete="off" type="text" class='tel' name="especialidad" required='required' onblur="validarEspecialidad()" data-validate-length-range="8,20" style="text-transform: uppercase;"/>
