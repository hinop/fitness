...
$(document).ready(function () {
    $("#registrar").on("click", function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('index.php/recepcion/cliente/agregarmodal'); ?>",
            data: formData,
...
<script>
    ...
    $('#search').on('input', function () {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/recepcion/cliente/search_results'); ?>",
            method: "POST",
            data: { query: query },
...
<script>
    ...
    $('#servicio').on('input', function () {
        ...
        $.ajax({
            url: "<?php echo base_url('index.php/recepcion/servicio/search_results'); ?>",
            method: "POST",
            data: { query: query },
            success: function (data) {
                resultsContainer.empty();
    ...
    function obtenerGrupos(servicioId) {
        $.ajax({
            url: "<?php echo base_url('index.php/recepcion/servicio/get_grupos'); ?>",
            method: "POST",
...
$(document).ready(function () {
    $('#guardarInscripcion').click(function () {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>index.php/recepcion/inscripcion/nuevaInscripcion",
            data: {
                idCliente: idCliente,
                idUsuario: idUsuario,
                fecha: fecha,
    ...
    if (response.status === 'success') {
        ...
        var comprobanteUrl = "<?php echo base_url(); ?>index.php/recepcion/inscripcion/comprobante?id=" + idVenta;
        window.open(comprobanteUrl, '_blank');
        window.location.href = "<?php echo base_url(); ?>index.php/recepcion/inscripcion/index";
    } else {
